...
export class PlayerService {
  public resourceUrl = environment.SERVER_API_URL + 'api/players';
  ...
  find(id: number): Observable<EntityResponseType> {
    return this.http.get<IPlayer>(`${this.resourceUrl}/telegram/${id}`, { observe: 'response' });
  }

  findPlayerDetail(id: number): Observable<HttpResponse<IPlayerReport>> {
    return this.http.get<IPlayerReport>(`${this.resourceUrl}/${id}/report`, { observe: 'response' });
  }
